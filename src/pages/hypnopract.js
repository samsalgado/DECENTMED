...
export function Hypnopract() {
    return(
        ...
        <title>Hypnotherapy Near Me</title>  
        <meta name="description" content="Hypnotherapy near me? Look no further than great hypnotherapists that can assist you with therapy and finding wholeness." />
      </Helmet>
