...
const {t} = useTranslation('common');
  ...
  return (
    <>
      ...
      <h1 style={{ textDecoration: 'underline', textAlign: 'center', fontFamily: "'Roboto', -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif" }}>{t("Ivermectin for Cancer in Humans")}
      </h1>
      </div>
       <div className="container-blue">
