...
const Blog12 = ({t}) => {
    ...
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
          <div className='pr'>
            ...
            <p>
            {t("Healthcare in Canada is a mess, adding holistic practices like acupuncture can help combat issues in the healthcare space. Although it is not as popular as other cities in Canada, Montreal has some great options for people seeking acupuncture treatment. For example, practioner")} <a href="https://acupuncture-clinic.ca/">Xiao Lei Wang,</a> {t("who practices moxibustion and cupping ('fire suckers'). There are many practitioners and different ways to practice acupuncture. Indeed, practitioner")} <a href="https://japanese-acupuncture-montreal.com/services/toyohari-acupuncture/">David Goldman</a>  {t("practices Toyohari Acupuncture or Meridan Therapy without insertion (millimeters above insertion points). The body has an immense regenerative potential to heal itself; herbalists believe that certain plants work in conjunction with the body to induce healing.")} <a href="https://www.acupuncturesinosante.com/home_fr.html">Sino-Santé Clinic</a> {t("uses Chinese herbs in conjunction with acupuncture treatment.")}
            </p>
            <p>
            {t("Acupuncture in Montreal started with an acupuncture boom in Ontario. Canada has seen an influx of Chinese immigrants and culture. One benefit is the mass adoption of TCM and acupuncture throughout the region. Acupuncture helps with many ailments: fertility,")} <a href="https://www.monacupuncteur.ca/en?pgid=lxqtnlqe-c3dea2c1-e155-4057-b8c1-feb24da43a55">bruxism,</a> {t("stress, pain relief and more. In a nation like Canada, acupuncture plays a pivotal role in fighting ailments that traditional medicine would not address.")}
            </p>
        </div>
        </div>
        <Footer />
