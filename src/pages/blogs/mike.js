...
const Mike = () => {
  ...
  return (
      ...
      <Helmet>
        ...
        <meta name="description" content={"Improve your sleep naturally with expert-backed holistic tips from naturopathylane. Discover simple lifestyle, diet, and wellness strategies for deeper, restorative sleep."} />
        </Helmet>
      <header>
        <Topbar />
      </header>
