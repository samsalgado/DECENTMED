  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="What is Bitcoin? Bitcoin is this simplified world, a way to transact and exchange person-to-person without a 'middleman.'" />
      </Helmet>
      <header>
        <Topbar />
      </header>
      <div className='container'>
      <h1 style={{ textDecoration: 'underline', textAlign: 'center', margin: '20px 0' }}>What is Bitcoin?</h1>
      ...
      <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
          <div className='pr'>
           ...
           <p>
           The concepts of digitized currency and transactions are not foreign and are primarily how the world already operates. According to the     <a href={'https://www.worldbank.org/en/news/press-release/2022/06/29/covid-19-drives-global-surge-in-use-of-digital-payments#:~:text=Two-thirds%20of%20adults%20worldwide,2017%20and%2042%25%20in%202011.'}>World Bank</a>:
    “2/3 of adults worldwide send or receive digital payments”. Banks have conducted fractional reserve banking since the 17th Century. Bitcoin implements the characteristics of digital currency, but you are your bank. Bitcoin is decentralized; there isn’t a need to put trust in a financial entity.
      </p>
      <p>
      To keep things as simple as possible, Bitcoin does the best job of correcting the problems of the traditional financial system. Bitcoin is deflationary, meaning its value is set and does not lose its worth over time. Around the world, currencies are losing value at a rapid rate. Bitcoin does a great job at injecting financial equality into places most affected by hyperinflation - Africa, South America, Latin America, and parts of Asia.
        </p>
      <p>
