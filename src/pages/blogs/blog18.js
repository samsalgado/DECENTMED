...
const Blog18 = () => {
  ...
  return (
      ...
      <Helmet>
        ...
        <meta name="description" content={"Discover five powerful stretches to ease back pain, recommended by Scottsdale health professionals. Improve mobility, reduce tension, and feel better naturally."} />
