...
const BlogPage = () => {
  ...
  return (
    ...
    <figure>
      ...
      <h2 style={{textDecoration:'underline', textAlign: 'center', margin: '20px 0' }}>Dry Needling vs Acupuncture</h2>
      <div className='pr'>
      <p>
    ...
    <br></br>
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
    <h2 style={{textDecoration:'underline', textAlign: 'center', margin: '20px 0' }}>How does the world get cheaper and less invasive healthcare?</h2>
    <div className='pr'>
        <p>
    ...
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
    <h2 style={{textDecoration:'underline', textAlign: 'center', margin: '20px 0' }}>What is Acupuncture?</h2>
    <div className='pr'>
        <p>
    ...
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
    <h2 style={{textDecoration:'underline', textAlign: 'center', margin: '20px 0' }}>Vitamin B: Vitamin B17 - The Mysterious Case of Cancer</h2>
    <div className='pr'>
        <p>
        According to the book World Without Cancer: The Story of Vitamin B17 by G. Edward Griffin, "Vitamin B17(Laetrile) can destroy cancer cells". In this article, we will explore the components of Laetrile, the book's claim and why vitamin B17 or Laetrile is illegal in the United States.
        </p>
        <div className='container'>
    <a href='/cancer'>
    <figure>
    ...
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
    <h2 style={{textDecoration:'underline', textAlign: 'center', margin: '20px 0' }}>What Is Hypnotherapy?</h2>
    <div className='pr'>
        <p>
    ...
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
    <h2 style={{textDecoration:'underline', textAlign: 'center', margin: '20px 0' }}>New Study Explores How Food Choices Shape Mental Health and Affect Depression</h2>
    <div className='pr'>
        <p>
        A new study from the University of Reading found that a poor-quality diet may be associated with changes in the brain structure that are linked to depression and anxiety.
        </p>
        <div className='container'>
    ...
    <figure>
        <img className='gridimag' src={depression} alt="logo" />
          <figcaption>Click on image for blog by Epoch Times on correlation between Food and Mental Health</figcaption>
        </figure>
      </a>
      </div>
        </div>
    ...
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
    <h2 style={{textDecoration:'underline', textAlign: 'center', margin: '20px 0' }}>The Importance of Nutrition</h2>
    <div className='pr'>
    <p>
    ...
    <div className='pr'>
        <p>
        Rose Oil stems from the petals of Rosa centifolia and Rosa damascena. First, we will explain the medicinal benefits of Rosa centifolia and Rosa damascena, according to PFAF.org. 
        </p>
        <div className='container'>
    <a href='/blog16'>
    <figure>
