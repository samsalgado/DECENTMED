        ...
        <div className="container-bblue">
            <div className="row justify-content-center">
                <div className="col-12 col-sm-6 col-md-3 text-center mb-4">
                    ...
                    <p className="edu">Showcase your company with a direct link to your booking page. The practices above will take users to a scrollview of  As the project scales, there will be built-in 24 hour scheduler.
                       Finally, all providers on the platform receive a showcase interview for your Telehealth portal.
                         </p>
                </div> 
                <div className="col-12 col-sm-6 col-md-3 text-center mb-4">
