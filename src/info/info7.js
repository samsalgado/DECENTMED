...
useEffect(() => {
  ...
  return (
    <div className='container'>
      ...
      <div className='parc'>
        <h2 style={{ textAlign: 'center', margin: '20px 0', fontFamily: "'Roboto', -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif"}}>{t('Attention Holistic Practitioners')}</h2>
        <p>
