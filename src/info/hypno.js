...
import dp from "../images copy/dp.png";
import AOS from 'aos';
...
const {t} = useTranslation('common');
  ...
  <div className="row">
     <iframe
              src="https://www.youtube.com/embed/CRZ0D2aHS-M?si=0xsw8lITDuZtcQwu"
              title='Hypnotherapy for the Zone'
              allow="autoplay"
              width="900"
              height="506"
              allowFullScreen
    ...
    <div className="col-12 col-md-6 mb-3">
      <a href="tel:+13016189801">
        <img src={ssreview} className="gridimage" alt="Hypnosis Silver Spring" />
      </a>
    </div>
        <div className="col-12 col-md-6 mb-3">
     <a href="https://calendly.com/donald-pelles/hypnotherapy-consultation?month=2025-06">
        <img src={framework} className="gridimage" alt="Hypnosis Silver Spring" />
      </a>
      </div>
  </div>
  <a href="https://www.hypnosissilverspring.com/online-hypnotherapy-sessions/" alt="Hypnosis Silver Spring">
     <img className='gridimage' src={dp} alt='SHEA SHULMAN THERAPY' />
    </a>
</Collapsible>
