    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-section office">
          ...
          <p>[5:35 am, Do me a favor and go through the site and make sure that the h1, h2 and text are all the same font
          
          
          Also you never fixed the form 
          I told you to do so a long time ago
            {t('Email:')}{' '}
